...
public class SMSServices {
     ...
     *
     */
    public static String sendSingleSMS(String username, String password, String message, String senderId, String mobileNumber, String secureKey, String templateid){
    ...
    public static String convertUnicodeMessage(String message){
        String finalmessage = "";
     ...
     * @param templateid :  templateId unique for each template message content
     */
    public static String sendUnicodeSMS(String username, String password, String message, String senderId, String mobileNumber, String secureKey, String templateid){
        String finalmessage = "";
        for(int i = 0 ; i< message.length();i++){
            char ch = message.charAt(i);
            int j = (int) ch;
